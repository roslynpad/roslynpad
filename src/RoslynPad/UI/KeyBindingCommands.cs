...
public static class KeyBindingCommands
{
    ...
    public const string Find = "actions.find";
    public const string Replace = "editor.action.startFindReplaceAction";
    public const string FindNext = "editor.action.nextMatchFindAction";
    public const string FindPrevious = "editor.action.previousMatchFindAction";
    ...
    public static IReadOnlyDictionary<string, CommandInfo> All { get; } = new Dictionary<string, CommandInfo>
    {
        ...
        [Find] = new(Find, "Find", "Ctrl+F", "Cmd+F"),
        [Replace] = new(Replace, "Replace", "Ctrl+H", "Cmd+Alt+F"),
        [FindNext] = new(FindNext, "Find Next", "F3", "Cmd+G"),
        [FindPrevious] = new(FindPrevious, "Find Previous", "Shift+F3", "Cmd+Shift+G"),
