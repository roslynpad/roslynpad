...
1. After the first run (which will fail), go to **Settings > Privacy & Security** to approve non-notarized apps after the first run attempt. For more information see [Open a Mac app from an unknown developer](https://support.apple.com/guide/mac-help/mh40616).
