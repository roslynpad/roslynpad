...
namespace Microsoft.VisualStudio.Language.Intellisense
{
    ...
    /// <see cref="Morgania.Text.Editor.ITextView"/>.
    /// </summary>
    public interface IPopupIntellisensePresenter : IIntellisensePresenter
    {
        /// <summary>
        /// Gets the WPF <see cref="Control"/> that the presenter wants to be displayed inside a
        /// <see cref="Morgania.Text.Editor.ITextView"/> popup.
        /// </summary>
        Control SurfaceElement { get; }
        ...
        /// place the <see cref="Morgania.Text.Editor.ITextView"/> popup inside of which the presenter's
