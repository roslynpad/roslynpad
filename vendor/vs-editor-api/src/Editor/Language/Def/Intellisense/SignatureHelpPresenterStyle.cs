...
namespace Microsoft.VisualStudio.Language.Intellisense
{
    ...
    {
        /// <summary>
        /// Gets a <see cref="IBrush"/> that will be used to paint the foreground of the signature help presenter.
        /// </summary>
        public virtual IBrush ForegroundBrush { get; protected set; }

        /// <summary>
        /// Gets a <see cref="IBrush"/> that will be used to paint the borders in the signature help presenter.
        /// </summary>
        public virtual IBrush BorderBrush { get; protected set; }

        /// <summary>
        /// Gets a <see cref="IBrush"/> that will be used to paint the background of the signature help presenter.
        /// </summary>
