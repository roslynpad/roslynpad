...
namespace Microsoft.VisualStudio.Text.Utilities
{
    ...
    internal static class Markers
    {
        ...
        public static Geometry GetMarkerGeometryFromRectangles(IList<Rect> rectangles)
        {
            ...
            // Morgania: WPF built a PathGeometry and outlined it (GetOutlinedPathGeometry);
            // Avalonia has no outline operation, so the union is expressed as a non-zero
            // GeometryGroup, which fills (and strokes) equivalently for marker rendering.
