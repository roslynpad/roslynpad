...
namespace Microsoft.VisualStudio.Text.EditorPrimitives.Implementation
{
    ...
    [Shared]
    public sealed class EditorPrimitivesFactoryService : IEditorPrimitivesFactoryService
    {
        [Import]
        public IViewPrimitivesFactoryService ViewPrimitivesFactory { get; set; }

        [Import]
        public IBufferPrimitivesFactoryService BufferPrimitivesFactory { get; set; }
