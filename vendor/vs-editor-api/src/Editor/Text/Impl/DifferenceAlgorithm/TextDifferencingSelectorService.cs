...
namespace Microsoft.VisualStudio.Text.Differencing.Implementation
{
    ...
    [Shared]
    public class TextDifferencingSelectorService : ITextDifferencingSelectorService
    {
        [ImportMany]
        public Lazy<ITextDifferencingService, ContentTypeMetadata>[] _textDifferencingServices { get; set; }
