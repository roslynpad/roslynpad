...
namespace Microsoft.VisualStudio.Text.Differencing.Implementation
{
    ...
    [Shared]
    public sealed class MaximalSubsequenceAlgorithm : IDifferenceService
    {
        #region IDifferenceService Members
        static readonly Microsoft.TeamFoundation.Diff.Copy.IDiffChange[] Empty = Array.Empty<Microsoft.TeamFoundation.Diff.Copy.IDiffChange>();
