...
namespace Microsoft.VisualStudio.Text.BraceCompletion.Implementation
{
    ...
    internal sealed class BraceCompletionAggregator : IBraceCompletionAggregator
    {
        ...
        {
            private Lazy<IBraceCompletionSessionProvider, BraceCompletionMetadata> _sessionPair;
            private Lazy<IBraceCompletionContextProvider, BraceCompletionMetadata> _contextPair;
            private Lazy<IBraceCompletionDefaultProvider, BraceCompletionMetadata> _defaultPair;

            public ProviderHelper(Lazy<IBraceCompletionSessionProvider, BraceCompletionMetadata> sessionPair)
            {
                _sessionPair = sessionPair;
            }

            public ProviderHelper(Lazy<IBraceCompletionContextProvider, BraceCompletionMetadata> contextPair)
            {
                _contextPair = contextPair;
            }

            public ProviderHelper(Lazy<IBraceCompletionDefaultProvider, BraceCompletionMetadata> defaultPair)
            {
