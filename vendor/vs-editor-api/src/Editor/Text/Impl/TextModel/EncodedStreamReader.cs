...
namespace Microsoft.VisualStudio.Text.Implementation
{
    ...
    internal class EncodedStreamReader
    {
        ...
        public static Encoding DetectEncoding(Stream stream,
                                              List<Lazy<IEncodingDetector, EncodingDetectorMetadata>> encodingDetectorExtensions,
        ...
        private static Encoding SniffForEncoding(Stream stream, List<Lazy<IEncodingDetector, EncodingDetectorMetadata>> orderedEncodingDetectors, GuardedOperations guardedOperations)
        {
            long position = stream.Position;

            foreach (Lazy<IEncodingDetector, EncodingDetectorMetadata> sniffer in orderedEncodingDetectors)
            {
