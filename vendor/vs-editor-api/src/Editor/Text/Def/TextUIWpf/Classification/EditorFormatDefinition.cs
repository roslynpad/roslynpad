...
namespace Microsoft.VisualStudio.Text.Classification
{
    ...
    public abstract class EditorFormatDefinition
    {
        ...
        /// </remarks>
        public IBrush BackgroundBrush { get; protected set; }
        ...
        /// </remarks>
        public IBrush ForegroundBrush { get; protected set; }
        ...
        protected virtual ResourceDictionary CreateResourceDictionaryFromDefinition()
        {
            ...
            // Morgania: Avalonia brushes have no Clone/Freeze; brushes supplied to format
            // definitions are treated as immutable (WPF Freezable semantics do not apply).
